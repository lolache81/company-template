  ...
  <div class="relative">
    <div class="h-screen">
      <div class="flex flex-col">
        ...
        -->
        <HeaderContent
          imgURL="https://images.indianexpress.com/2019/07/filter-coffee_759.jpg"
          header_txt="Testing 123"
        ...
        -->
        <AboutContent imgURL="https://www.digiwebconsulting.com/img/about-us.png">
          <template
            v-slot:about
